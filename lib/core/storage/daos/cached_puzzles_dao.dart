...
class CachedPuzzlesDao extends DatabaseAccessor<AppDatabase>
  ...
  /// Removes every cached puzzle. Used by the schema-8 migration to drop puzzles
  /// generated by the old algorithm so the device redraws from the new pool.
  Future<void> clearAll() => delete(cachedPuzzles).go();
}
