    ...
    child: Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: AppSpacing.lg),
          const PondLoader(theme: PondLoaderTheme.puzzle, label: 'Loading puzzle'),
          const SizedBox(height: AppSpacing.lg),
          const PondLoader(theme: PondLoaderTheme.auth, label: 'Loading account'),
          const SizedBox(height: AppSpacing.lg),
          const PondLoader(
          ...
          const SizedBox(height: AppSpacing.lg),
          const PondLoader(theme: PondLoaderTheme.store, label: 'Loading the store'),
        ],
      ),
    ),
  );
