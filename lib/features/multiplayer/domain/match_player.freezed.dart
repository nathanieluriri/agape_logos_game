...
mixin _$MatchPlayer {
 ...
 String get uid; String get displayName; String get avatarId; bool get isGuest; bool get ready; bool get connected; int get score; int get wordsFound; int get endsAtBonusMs; int get lastWordAt; int get finishedAt; int get lastSeen;
...
@override
int get hashCode => Object.hash(runtimeType,uid,displayName,avatarId,isGuest,ready,connected,score,wordsFound,endsAtBonusMs,lastWordAt,finishedAt,lastSeen);

@override
String toString() {
  return 'MatchPlayer(uid: $uid, displayName: $displayName, avatarId: $avatarId, isGuest: $isGuest, ready: $ready, connected: $connected, score: $score, wordsFound: $wordsFound, endsAtBonusMs: $endsAtBonusMs, lastWordAt: $lastWordAt, finishedAt: $finishedAt, lastSeen: $lastSeen)';
}
...
@useResult
$Res call({
 String uid, String displayName, String avatarId, bool isGuest, bool ready, bool connected, int score, int wordsFound, int endsAtBonusMs, int lastWordAt, int finishedAt, int lastSeen
});
...
/// Create a copy of MatchPlayer
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uid = null,Object? displayName = null,Object? avatarId = null,Object? isGuest = null,Object? ready = null,Object? connected = null,Object? score = null,Object? wordsFound = null,Object? endsAtBonusMs = null,Object? lastWordAt = null,Object? finishedAt = null,Object? lastSeen = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uid,  String displayName,  String avatarId,  bool isGuest,  bool ready,  bool connected,  int score,  int wordsFound,  int endsAtBonusMs,  int lastWordAt,  int finishedAt,  int lastSeen)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MatchPlayer() when $default != null:
return $default(_that.uid,_that.displayName,_that.avatarId,_that.isGuest,_that.ready,_that.connected,_that.score,_that.wordsFound,_that.endsAtBonusMs,_that.lastWordAt,_that.finishedAt,_that.lastSeen);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uid,  String displayName,  String avatarId,  bool isGuest,  bool ready,  bool connected,  int score,  int wordsFound,  int endsAtBonusMs,  int lastWordAt,  int finishedAt,  int lastSeen)  $default,) {final _that = this;
switch (_that) {
case _MatchPlayer():
return $default(_that.uid,_that.displayName,_that.avatarId,_that.isGuest,_that.ready,_that.connected,_that.score,_that.wordsFound,_that.endsAtBonusMs,_that.lastWordAt,_that.finishedAt,_that.lastSeen);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uid,  String displayName,  String avatarId,  bool isGuest,  bool ready,  bool connected,  int score,  int wordsFound,  int endsAtBonusMs,  int lastWordAt,  int finishedAt,  int lastSeen)?  $default,) {final _that = this;
switch (_that) {
case _MatchPlayer() when $default != null:
return $default(_that.uid,_that.displayName,_that.avatarId,_that.isGuest,_that.ready,_that.connected,_that.score,_that.wordsFound,_that.endsAtBonusMs,_that.lastWordAt,_that.finishedAt,_that.lastSeen);case _:
  return null;
...
class _MatchPlayer implements MatchPlayer {
  const _MatchPlayer({required this.uid, required this.displayName, required this.avatarId, required this.isGuest, required this.ready, required this.connected, required this.score, required this.wordsFound, this.endsAtBonusMs = 0, this.lastWordAt = 0, this.finishedAt = 0, this.lastSeen = 0});
...
/// Create a copy of MatchPlayer
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uid = null,Object? displayName = null,Object? avatarId = null,Object? isGuest = null,Object? ready = null,Object? connected = null,Object? score = null,Object? wordsFound = null,Object? endsAtBonusMs = null,Object? lastWordAt = null,Object? finishedAt = null,Object? lastSeen = null,}) {
