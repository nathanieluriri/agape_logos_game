...
const BASE_ITEMS: StoreItem[] = [
  ...
  },
  {
    id: "combo_lock",
    name: "Combo Lock",
    description: "Ward off Word Steal for 20 seconds.",
    category: "powerup",
    kind: "defense",
    cost: 110,
    maxPerPurchase: 10,
    effect: {target: "self", durationSec: 20, rule: "Word Steal cannot touch you for 20s."},
  },
  {
    id: "time_boost",
    name: "Time Boost",
    description: "Add 30 seconds to your own clock.",
    category: "powerup",
    kind: "utility",
    cost: 80,
    maxPerPurchase: 20,
    effect: {target: "self", durationSec: 30, rule: "+30s to your round timer."},
  },
  {
    id: "double_points",
    name: "Double Points",
    description: "Your valid words score double for 20 seconds.",
    category: "powerup",
    kind: "utility",
    cost: 140,
    maxPerPurchase: 10,
    effect: {target: "self", durationSec: 20, magnitude: 2, rule: "2x points on valid words for 20s."},
  },
];
